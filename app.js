...
var UIController = (function () {
    ...
    return {
        ...
        deleteAllListItems: function () {
            removeAllChildren(document.querySelector(DOMstrings.incomeContainer));
            removeAllChildren(document.querySelector(DOMstrings.expensesContainer));
        },
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var setupEventListeners = function () {
        ...
        document.querySelector(DOM.deleteBtn).addEventListener('click', ctrlDeleteAll);
    };
    ...
    var ctrlAddItem = function () {
        ...
        if (input.description === "" || Number.isNaN(input.value)) return;
    ...
    var ctrlDeleteItem = function (event) {
        ...
        if (itemID) {
            ...
            type = splitID[0];
            ID = parseInt(splitID[1]); // Cast to number
    ...
    var ctrlDeleteAll = function () {
        // 1. Delete all items from the data structure
        budgetCtrl.deleteAll();

        // 2. Delete all elements in the income and expenses lists
    ...
    return {
        init: function () {
            ...
            if (!('indexedDB' in window)) {
                ...
                console.log('IDB implementation currently defunct');
            }
